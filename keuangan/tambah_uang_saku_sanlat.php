...
<body>
    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            ...
            <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tambah Uang Saku <?php echo $santri['nama_lengkap']; ?></h5>

              <!-- Multi Columns Form -->
              <form class="row g-3" method="post" action="proses_tambah_uang_saku_sanlat.php">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" id="inputName5" name="jumlah_saldo">
                </div>
